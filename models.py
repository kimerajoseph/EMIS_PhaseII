...
class monthlyBillingData(db.Model):
    ...
    max_dem1 = db.Column(db.Numeric(15, 2), nullable=True)
    max_dem1_datatime = db.Column(db.DateTime, nullable=True)
    max_dem2 = db.Column(db.Numeric(15, 2), nullable=True)
    max_dem2_datatime = db.Column(db.DateTime, nullable=True)
    max_dem3 = db.Column(db.Numeric(15, 2), nullable=True)
    max_dem3_datatime = db.Column(db.DateTime, nullable=True)
    ...
    no_of_resets = db.Column(db.Integer(), nullable=True)
    date_of_last_reset = db.Column(db.DateTime, nullable=True)
    programing_count = db.Column(db.Integer(), nullable=True)
    CT_ratio = db.Column(db.String(255), nullable=True)
    VT_ratio = db.Column(db.String(255), nullable=True)
